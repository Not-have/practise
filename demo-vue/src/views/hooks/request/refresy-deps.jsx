...
const Demo2 = defineComponent({
    setup() {
        ...
        return () => (<Card title="Computed 依赖刷新" class="mt-2">
                <Typography>
                    <Typography.Paragraph>
                        <Typography.Text type="danger"> options.refreshDeps </Typography.Text>
                        可以是计算类型
...
const Demo3 = defineComponent({
    setup() {
        ...
        return () => (<Card title="Function 依赖刷新" class="mt-2">
                <Typography>
                    <Typography.Paragraph>
                        <Typography.Text type="danger"> options.refreshDeps </Typography.Text>
                        可以是一个方法，但必须是一个关于响应型数据 Reactive、Ref、Computed 的 effect
                        函数
                    </Typography.Paragraph>
...
export default defineComponent({
    setup() {
        return () => (<PageWrapper title="依赖刷新" v-slots={{

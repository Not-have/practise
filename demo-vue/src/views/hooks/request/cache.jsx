...
const Demo2 = defineComponent({
    setup() {
        ...
        return () => (<Card title="数据保持新鲜" class="mt-2">
                <Typography>
                    <Typography.Paragraph>
                        通过设置
...
const Demo3 = defineComponent({
    setup() {
        return () => (<Card title="数据共享" class="mt-2">
                <Typography>
                    <Typography.Paragraph>
...
const Demo4 = defineComponent({
    setup() {
        ...
        return () => (<Card title="参数缓存" class="mt-2">
                <Typography>
                    <Typography.Paragraph>
...
const Demo5 = defineComponent({
    setup() {
        ...
        return () => (<Card title="删除缓存" class="mt-2">
                <Typography>
                    <Typography.Paragraph>
...
const Demo6 = defineComponent({
    setup() {
        ...
        return () => (<Card title="自定义缓存" class="mt-2">
                <Typography>
                    <Typography.Paragraph>

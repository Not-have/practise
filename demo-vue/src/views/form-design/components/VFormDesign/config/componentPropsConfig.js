export const baseComponentControlAttrs = [
    {
        name: 'disabled',
        label: '禁用'
    },
...
export const baseComponentCommonAttrs = [
    {
        name: 'size',
        label: '尺寸',
...
export const baseComponentAttrs = componentAttrs;
const findCompoentProps = (props, name) => {
    const idx = props.findIndex((value) => {

...
export function useTableFooter(propsRef, scrollRef, tableElRef, getDataSourceRef) {
    ...
    function handleSummary() {
        ...
        nextTick(() => {
            ...
            useEventListener({
                ...
                name: 'scroll',
                listener: () => {
                    const footerBodyDom = tableEl.$el.querySelector('.ant-table-footer .ant-table-container  [class^="ant-table-"]');

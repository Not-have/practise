...
interface _CustomComponents {
    ...
    >;
    IconPicker: ExtractPropTypes<
        (typeof import('@/components/Icon/src/IconPicker.vue'))['default']
    >;
    ...
    >;
    BasicTitle: ExtractPropTypes<
        (typeof import('@/components/Basic/src/BasicTitle.vue'))['default']
    >;
